...
export class SfnStack extends cdk.Stack {
  ...
  constructor(scope: Construct, id: string, props: SfnStackProps) {
    ...
    const bedrockEnhancementTask = new tasks.LambdaInvoke(
      this,
      "BedrockEnhancementTask",
      {
    ...
    const standardEnhancementTask = new tasks.LambdaInvoke(
      this,
      "StandardEnhancementTask",
      {
    ...
    this.aiIngestionWorkflow = new sfn.StateMachine(
      this,
      "AIIngestionWorkflow",
      {
    ...
    props.standardEnhancementFunction.grantInvoke(
      this.aiIngestionWorkflow.role,
    );
